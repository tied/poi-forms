define('com.mesilat:format',[],function(){
    var SSF = ({});
        ...
        function eval_fmt(fmt, v, opts, flen) {
            ...
            for (i = 0; i < out.length; ++i) {
                switch (out[i].t) {
                    ...
                    case '?':
                        jj = i + 1;
                        while (jj < out.length  /*out[jj] !== null*/ && (
                                (c = out[jj].t) === "?" || c === "D" ||
                                ((c === " " || c === "t") && jj + 1 < out.length /* out[jj + 1] !== null */ && (out[jj + 1].t === '?' || out[jj + 1].t === "t" && out[jj + 1].v === '/')) ||
                                (out[i].t === '(' && (c === ' ' || c === 'n' || c === ')')) ||
...
define('com.mesilat:named-format',['com.mesilat:format'],function(SSF){
    var XLMLFormatMap = ({
